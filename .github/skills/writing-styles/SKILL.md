...
| Style | Best for | Core principle |
|---|---|---|
| `professional` | Memos, strategy reports, recommendations for decision-makers | Answer first. Quantify everything. (Pyramid Principle) |
| `journalist` | Research reports, long-form essays, narrative explainers | Hook → nut graf → evidence → kicker |
...
Load the file for the chosen style before writing:

- **Professional**: [./professional.md](./professional.md)
- **Journalist**: [./journalist.md](./journalist.md)
...
1. Identify the target style (from user request or context)
2. Load the corresponding reference file
3. Apply its structure, tone, and sentence-level rules throughout
4. Run its pre-publish checklist before finalizing

## What Makes Each Style Fail (Quick Reference)

| Style | #1 failure mode |
|---|---|
| professional | Buries the answer at the end instead of leading with it |
| journalist | Abstract opening with no scene or concrete fact |
